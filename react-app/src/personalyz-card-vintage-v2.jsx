...
/*
 ...
 ║  v2 — Pure typographic masthead, no banner image             ║
 ╚══════════════════════════════════════════════════════════════╝
*/
...
const O = {
  parchment: "#F5EFE0", parchDark: "#EDE4D0", parchDeep: "#E3D8C2",
  cream: "#FAF6ED", linen: "#F0E9D8",
  espresso: "#2C1810", ink: "#3D2B1F", inkMid: "#5C4033", inkLight: "#7A6455",
  tan: "#9C8B7A", dusty: "#B5A696", faded: "#C9BFB2",
  brass: "#A67C52", brassLight: "#C49A6C", brassDark: "#8B6340",
  copper: "#B87333", rust: "#8B4513",
  burgundy: "#6B1C23", burgundySoft: "#F5E8EA",
  forest: "#2D4A2D", forestSoft: "#EDF2ED",
  border: "#D4C9B8", borderDark: "#BFB19D", borderFine: "#E4DDD0",
};
...
function WideOrnament({ color = O.brass }) {
  return (
    <svg width="100%" height="16" viewBox="0 0 300 16" preserveAspectRatio="xMidYMid meet" style={{ display: "block", margin: "0 auto" }}>
      <line x1="0" y1="8" x2="90" y2="8" stroke={color} strokeWidth="0.5" />
      <line x1="210" y1="8" x2="300" y2="8" stroke={color} strokeWidth="0.5" />
      {/* Left flourish */}
      <circle cx="95" cy="8" r="1.5" fill={color} />
      <path d="M102 8 Q110 3, 118 8 Q110 13, 102 8 Z" fill="none" stroke={color} strokeWidth="0.6" />
      {/* Center diamond */}
      <path d="M130 8 L150 2 L170 8 L150 14 Z" fill="none" stroke={color} strokeWidth="0.7" />
      <path d="M138 8 L150 4 L162 8 L150 12 Z" fill="none" stroke={color} strokeWidth="0.5" />
      <circle cx="150" cy="8" r="2" fill={color} />
      {/* Right flourish */}
      <path d="M182 8 Q190 3, 198 8 Q190 13, 182 8 Z" fill="none" stroke={color} strokeWidth="0.6" />
      <circle cx="205" cy="8" r="1.5" fill={color} />
    </svg>
  );
}
  ...
  return (
    <div>
      <button onClick={() => setOpen(!open)} style={{
        ...
        <div style={{ width: "100%", marginBottom: 8 }}><SmallOrnament /></div>
        <span style={{
          fontSize: 15, fontWeight: 700, color: O.espresso,
...
// ══════════════════════════════════════════════════════════════
export default function VintageCardV2() {
  ...
  return (
    <div style={{
      ...
      {/* ═══════════════════════════════════════════════════
          MASTHEAD — Pure typographic header, no image
          ═══════════════════════════════════════════════════ */}
      <div style={{
        background: O.espresso, padding: "28px 20px 36px",
        textAlign: "center", position: "relative",
        borderBottom: `3px double ${O.brass}`,
      }}>
        {/* Subtle aged texture */}
        <div style={{
          position: "absolute", inset: 0, opacity: 0.04,
          backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.7' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.8'/%3E%3C/svg%3E")`,
        }} />

        {/* Top decorative border */}
        <div style={{
          position: "absolute", top: 8, left: 14, right: 14,
          borderTop: `1px solid ${O.brass}40`,
          borderLeft: `1px solid ${O.brass}40`,
          borderRight: `1px solid ${O.brass}40`,
          height: 6,
        }} />

        {/* "Est." line */}
        <div style={{
          fontSize: 9, color: O.brassLight, letterSpacing: "0.25em",
          textTransform: "uppercase", marginBottom: 6,
          fontFamily: "'Crimson Pro', serif", fontWeight: 500,
          opacity: 0.6,
        }}>— Purveyors of Fine Digital Calling Cards —</div>

        {/* Company name — blackletter */}
        <div style={{
          fontSize: 34, color: O.brassLight,
        ...
        {/* Ornate rule */}
        <div style={{ margin: "6px auto 8px", width: 200 }}>
          <WideOrnament color={O.brass + "90"} />
        </div>

        {/* Tagline */}
        <div style={{
          fontSize: 11, color: "rgba(196,154,108,0.5)",
          fontFamily: "'Crimson Pro', serif", fontStyle: "italic",
          letterSpacing: "0.04em",
        }}>Est. MMXXV · Nairobi</div>

        {/* Bottom decorative border */}
        <div style={{
          position: "absolute", bottom: 8, left: 14, right: 14,
          borderBottom: `1px solid ${O.brass}40`,
          borderLeft: `1px solid ${O.brass}40`,
          borderRight: `1px solid ${O.brass}40`,
          height: 6,
        }} />
      ...
      {/* ═══════════════════════════════════════════════════
          PROFILE + IDENTITY — Directly below masthead
          ═══════════════════════════════════════════════════ */}
      <div style={{
        margin: "0 14px", background: O.cream,
        border: `1px solid ${O.border}`, borderTop: "none",
        ...
        {/* Profile pic — brass oval frame */}
        <div style={{
          width: 96, height: 96, borderRadius: "50%", margin: "0 auto 14px",
          border: `4px solid ${O.brass}`,
          boxShadow: `0 0 0 2px ${O.cream}, 0 0 0 4px ${O.brassLight}40, 0 4px 16px rgba(44,24,16,0.2)`,
          overflow: "hidden", background: O.parchDark,
        }}>
        ...
        <h1 style={{
          fontSize: 36, fontWeight: 900, color: O.espresso, margin: "0 0 0",
          fontFamily: "'Playfair Display', serif",
          letterSpacing: "-0.02em", lineHeight: 1,
        }}>Batman</h1>

        <div style={{ margin: "8px auto", width: 160 }}><OrnateRule /></div>
      ...
      <div style={{ margin: "10px 14px 0", background: O.cream, border: `1px solid ${O.border}` }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3px 14px" }}>
            {[
              ...
              <div key={day} style={{
                ...
                padding: "5px 8px", borderBottom: `1px dotted ${on ? O.borderFine : "transparent"}`,
              }}>
                <span style={{ fontSize: 12.5, fontWeight: 600, color: on ? O.ink : O.faded, fontStyle: on ? "normal" : "italic" }}>{day.substring(0, 3)}</span>
                <span style={{ fontSize: 11.5, fontWeight: 400, color: on ? O.inkMid : O.faded, fontStyle: "italic" }}>{time}</span>
              </div>
            ))}
          </div>
        </Sec>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: rating ? 12 : 0 }}>
            {[
              ...
              <button key={r.val} onClick={() => setRating(r.val)} className="v-press" style={{
                ...
                background: rating === r.val ? r.bg : O.cream, borderRadius: 0, transition: "all 0.2s",
              }}>
                <span style={{ fontSize: 24, lineHeight: 1, color: r.c }}>{r.icon}</span>
                <span style={{ fontSize: 8.5, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: rating === r.val ? r.c : O.dusty }}>{r.label}</span>
              </button>
            ))}
          </div>
          {rating && (
        ...
        <Sec title="Request an Audience">
          <div style={{ marginBottom: 12 }}>
            <label style={{ fontSize: 10, fontWeight: 700, color: O.dusty, letterSpacing: "0.12em", textTransform: "uppercase", display: "block", marginBottom: 4 }}>Date of Appointment</label>
            <input type="date" defaultValue="2026-02-24" style={{
              width: "100%", padding: "10px 14px", border: `1px solid ${O.border}`,
              fontSize: 13.5, fontFamily: "'Crimson Pro', serif",
              color: O.espresso, outline: "none", background: O.parchment, boxSizing: "border-box", borderRadius: 0,
            }} />
          </div>
          <label style={{ fontSize: 10, fontWeight: 700, color: O.dusty, letterSpacing: "0.12em", textTransform: "uppercase", display: "block", marginBottom: 5 }}>Preferred Hour</label>
          ...
          {!moreTimes && (
            <button onClick={() => setMoreTimes(true)} style={{
              ...
              cursor: "pointer", fontFamily: "'Crimson Pro', serif", fontStyle: "italic", marginBottom: 6,
        ...
        <Sec title="Our Services">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {[
              ...
              <div key={i} className="v-press" style={{
                border: `1px solid ${O.border}`, overflow: "hidden",
                cursor: "pointer", transition: "transform 0.15s", background: O.cream,
              }}>
                <div style={{ height: 80, position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ position: "absolute", bottom: 5, left: 7, right: 7, fontSize: 11, fontWeight: 700, color: O.parchment, fontFamily: "'Playfair Display', serif", lineHeight: 1.2, textShadow: "0 1px 3px rgba(0,0,0,0.5)" }}>{svc.title}</div>
                </div>
                <div style={{ padding: "8px 9px 10px" }}>
                  <div style={{ fontSize: 11, color: O.inkLight, lineHeight: 1.55, fontStyle: "italic", marginBottom: 8, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{svc.desc}</div>
                  <button style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ position: "absolute", top: 2, right: 6, fontSize: 40, fontFamily: "Georgia, serif", color: O.parchDeep, lineHeight: 1, fontWeight: 700 }}>"</div>
                <div style={{
                  width: 38, height: 38, borderRadius: "50%", marginBottom: 8,
                  overflow: "hidden", border: `2px solid ${O.brass}`, boxShadow: `0 0 0 1px ${O.parchment}`,
                }}>
                  <img src={TEST_IMGS[i]} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", filter: "sepia(0.2) contrast(1.05)" }} />
                </div>
                <Stars n={t.stars} />
                <div style={{ fontSize: 11.5, color: O.inkMid, lineHeight: 1.6, marginTop: 6, marginBottom: 8, fontStyle: "italic" }}>"{t.text}"</div>
                <div style={{ fontSize: 11, fontWeight: 700, color: O.espresso, fontFamily: "'Playfair Display', serif" }}>— {t.name}</div>
              </div>
            ))}
          </div>
        </Sec>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 14 }}>
            {[
              ...
              <button key={i} className="v-press" style={{
                ...
                {s.icon}
                <span style={{ fontSize: 7, fontWeight: 700, color: O.dusty, letterSpacing: "0.06em", textTransform: "uppercase" }}>{s.label}</span>
              </button>
            ))}
          </div>
        </Sec>
      ...
      <div style={{ margin: "10px 14px 0", background: O.cream, border: `1px solid ${O.border}` }}>
        <Sec title="Our Location" noPad>
          <div style={{ margin: "0 18px 16px", overflow: "hidden", height: 165, border: `1px solid ${O.border}`, boxShadow: "inset 0 0 12px rgba(44,24,16,0.08)" }}>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d190255.502320959!2d-87.89668624561754!3d41.83384858178919!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880e2c3cd0f4cbed%3A0xafe0a6ad09c0c000!2sChicago%2C%20IL%2C%20USA!5e0!3m2!1sen!2sza!4v1765441428500!5m2!1sen!2sza" width="100%" height="100%" style={{ border: 0, display: "block", filter: "sepia(0.25) saturate(0.8)" }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
        </Sec>

        <Sec title="Featured Content" open={false}>
          <div style={{ border: `1px solid ${O.border}`, background: O.parchment, padding: "18px 14px", textAlign: "center" }}>
            ...
            <div style={{ fontSize: 12, color: O.tan, fontStyle: "italic", lineHeight: 1.5 }}>LinkedIn despatches, finance applications, or bespoke embeds shall render here.</div>
          </div>
        </Sec>

        <Sec title="Gallery">
          <div style={{ height: 185, marginBottom: 8, overflow: "hidden", position: "relative", border: `1px solid ${O.border}`, boxShadow: "inset 0 0 16px rgba(44,24,16,0.08)" }}>
            <img src={GALLERY_IMGS[galIdx]} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", filter: "sepia(0.15) contrast(1.05) saturate(0.85)", transition: "opacity 0.3s" }} />
            <button onClick={() => setGalIdx(Math.max(0, galIdx - 1))} style={{ position: "absolute", left: 8, top: "50%", transform: "translateY(-50%)", width: 30, height: 30, borderRadius: "50%", background: "rgba(44,24,16,0.55)", border: `1px solid ${O.brass}50`, color: O.parchment, fontSize: 15, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", opacity: galIdx === 0 ? 0.3 : 1 }}>‹</button>
            <button onClick={() => setGalIdx(Math.min(GALLERY_IMGS.length - 1, galIdx + 1))} style={{ position: "absolute", right: 8, top: "50%", transform: "translateY(-50%)", width: 30, height: 30, borderRadius: "50%", background: "rgba(44,24,16,0.55)", border: `1px solid ${O.brass}50`, color: O.parchment, fontSize: 15, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", opacity: galIdx === GALLERY_IMGS.length - 1 ? 0.3 : 1 }}>›</button>
            <div style={{ position: "absolute", bottom: 8, right: 10, padding: "3px 10px", background: "rgba(44,24,16,0.6)", border: `1px solid ${O.brass}40`, color: O.parchment, fontSize: 10, fontWeight: 600, fontStyle: "italic" }}>{galIdx + 1} of {GALLERY_IMGS.length}</div>
          </div>
          <div className="v-scroll" style={{ display: "flex", gap: 6, overflowX: "auto", scrollbarWidth: "none" }}>
            {GALLERY_IMGS.map((img, i) => (
              <button key={i} onClick={() => setGalIdx(i)} style={{ width: 50, height: 50, flexShrink: 0, overflow: "hidden", cursor: "pointer", padding: 0, background: "none", border: galIdx === i ? `2.5px solid ${O.brass}` : `1.5px solid ${O.border}`, opacity: galIdx === i ? 1 : 0.5, transition: "all 0.2s", borderRadius: 0 }}>
                <img src={img} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", filter: "sepia(0.2) saturate(0.8)" }} />
              </button>
            ))}
          </div>
        </Sec>
      ...
      <div style={{
        ...
        padding: "22px 18px 36px", textAlign: "center", position: "relative",
      }}>
        <div style={{ marginBottom: 14 }}><OrnateRule color={O.brass + "80"} /></div>
        <div style={{ fontSize: 22, color: O.brassLight, fontFamily: "'UnifrakturMaguntia', cursive", marginBottom: 4, letterSpacing: "0.02em" }}>Personalyz</div>
        <div style={{ fontSize: 10.5, color: "rgba(245,239,224,0.3)", fontStyle: "italic", marginBottom: 10 }}>Purveyors of Fine Digital Calling Cards — Est. MMXXV</div>
        <div style={{ display: "inline-block", padding: "5px 14px", border: `1px solid rgba(166,124,82,0.25)` }}>
          <span style={{ fontSize: 10, color: "rgba(245,239,224,0.35)", fontStyle: "italic" }}>cards.personalyz.me/ToyotaKenya/batman</span>
        </div>
        <div style={{ marginTop: 14 }}><span style={{ fontSize: 16, color: O.brass + "60" }}>❦</span></div>
      </div>
    </div>
  );
}
