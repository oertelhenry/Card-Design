...
export default function FormalCard() {
  ...
  return (
    <div style={{
      maxWidth: 420, margin: "0 auto", background: P.warm,
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{ position: "absolute", left: "50%", bottom: -46, transform: "translateX(-50%)", zIndex: 5 }}>
          <div style={{
            width: 92, height: 92, borderRadius: "50%",
            border: `3px solid ${P.card}`, overflow: "hidden",
      ...
      <div style={{
        ...
        padding: "54px 22px 20px", textAlign: "center",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {[
              ...
              <div key={i} style={{
                ...
                background: P.warm, border: `1px solid ${P.borderFine}`,
                position: "relative",
              }}>
                {/* Decorative top line */}
      ...
      <div style={{ margin: "10px 14px 0", borderRadius: 16, overflow: "hidden", background: P.card, boxShadow: "0 1px 3px rgba(0,0,0,0.03)" }}>
        ...
        <Sec title="Gallery" icon={I.img}>
          <div style={{
            height: 190, borderRadius: 12, marginBottom: 8,
